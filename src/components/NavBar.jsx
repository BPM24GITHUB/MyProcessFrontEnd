...
import { RiNotification3Line,RiMenu3Line,RiMenu2Line } from 'react-icons/ri';
  ...
  return (
      ...
      <div
       ...
       >
        ...
        color="blue" icon={activeMenu? <RiMenu2Line />: <RiMenu3Line />}/>
      
      <div
        className='flex'
       >
        <NavButton title="Card" 
          ...
          > 
            <img 
              ...
              <p>
                ...
                <span className='text-gray-400 font-bold ml-1 text-14' >Anwar </span>
              </p>
